...
You may not use any of the standard conversion methods available in Ruby, such as String#to_i, Integer(), etc. You may, however, 
...
def string_to_signed_integer(str)
  case str
    when str[0] == "+"
      then string_to_integer(str[1..-1]) 
    when str[0] == "-"
      then -string_to_integer(str[1..-1])
