# A UUID is a type of identifier often used as a way to uniquely identify items...which may not all be created by the same system. That is, without any form of 
# synchronization, two or more separate computer systems can create new items and label them with a UUID with no significant chance of stepping on each other's toes.
...
# input = method called
#output = string. With 32 characters randomly assigned between numbers and lowercase letters
